...
shoppingcart.insert_item('Apple', 10, 1)
shoppingcart.insert_item('Apple', 20, 3)
itemab = shoppingcart.get_item('Apple')
print(itemab.price)
print(shoppingcart.get_item_count('Apple'))
shoppingcart.delete_item('Apple')
print(shoppingcart.get_item_count('Apple'))
print(shoppingcart.get_item('Mango'))
print(shoppingcart.get_total_price())